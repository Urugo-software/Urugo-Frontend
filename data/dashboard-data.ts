...
export const roleNavItems: Record<RoleType, NavItemConfig[]> = {
  ...
  landlord: [
    ...
    { label: "My Properties", href: "/landlord/properties", icon: Building2, badge: 6 },
    { label: "Renters", href: "/landlord/renters", icon: User, badge: 8 },
    { label: "Tenancies", href: "/landlord/tenancies", icon: ScrollText },
    { label: "Blacklist Check", href: "/landlord/blacklist-check", icon: FileText, badge: 1 },
    { label: "Notifications", href: "/landlord/notifications", icon: Bell, badge: 2 },
  ],
  renter: [
