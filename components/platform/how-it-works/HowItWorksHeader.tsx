...
export interface HowItWorksHeaderProps {
  subTitle?: string;
  title?: string;
  description?: string;
}
...
export default function HowItWorksHeader({
  ...
  title = "Explore roles.",
  description = "Whether you own a property, rent one, or you're just looking, here's exactly what happens on Urugo, step by step.",
